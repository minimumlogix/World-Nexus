...
exports.initUniversalWorker = exports.createWorkerPool = exports.exec = void 0;
...
const createWorkerPool = (builder, limit = 4) => {
    ...
    const execute = async (name, ...value) => {
        ...
        (0, exports.exec)(target.worker, name, registry, ...value)
...
const initUniversalWorker = (worker, WorkerProc) => {
...
exports.initUniversalWorker = initUniversalWorker;
